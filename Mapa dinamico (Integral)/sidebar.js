...
attributions: ' ',
              params: {
                "LAYERS": "geonode:aeropuertos",
                "TILED": "true",
                "VERSION": "1.3.0"},
            })),
            title: '<img src="legend/Aeropuertos_15.png" /> Aeropuertos',
            opacity: 1.000000,
            visible: true,
...
attributions: ' ',
  params: {
    "LAYERS": ["geonode:Pasos_de_Frontera", "geonode:Puertos", "geonode:ferroviario_no_operativo"],
    "TILED": "true",
    "VERSION": "1.3.0"},
}));
